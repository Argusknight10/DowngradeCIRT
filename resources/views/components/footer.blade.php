        ...
        <div class="md:flex md:justify-between">
            <div class="mb-6 md:mb-0">
                <a href="{{ route('home') }}" class="text-white font-medium flex flex-col gap-2 lg:gap-5 items-start">
                    <img src="/img/pens.png" class="h-24 mr-3" alt="PENS LOGO" />
                        <span class="font-bold my-4">Cyber Incident Response Team</span>
                        <p class="max-w-xs"> Tim Penanganan Insiden Keamanan Siber <br>
